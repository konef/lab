...
function refreshScoreData(team1, team2) {
    if (team1) {
        document.getElementById('nameFirstT').innerText = team1.name;
        document.getElementById('scoreFirstT').innerText = team1.coinsCollected || 0;
        document.getElementById('lifesFirstT').innerText = team1.currentLives;
    }

    if (team2) {
        document.getElementById('nameSecondT').innerText = team2.name;
        document.getElementById('scoreSecondT').innerText = team2.coinsCollected || 0;
        document.getElementById('lifesSecondT').innerText = team2.currentLives || 0;
    }
};
