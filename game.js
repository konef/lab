...
var ctlProgress = document.getElementById("pbar");
var logBox = document.getElementById("txtlog");
/* BLOCK 1 END */
...
function refreshScoreData(team1, team2) {
    if (team1) {
        document.getElementById('ftName').innerText = 'Название: ' + team1.name;
        document.getElementById('ftScore').innerText = 'Очки: ' + team1.coinsCollected || 0;
        document.getElementById('ftLifes').innerText = 'Осталось жизней: ' + team1.currentLives;
    }

    if (team2) {
        document.getElementById('stName').innerText = 'Название: ' + team2.name;
        document.getElementById('stScore').innerText = 'Очки: ' + team2.coinsCollected || 0;
        document.getElementById('stLifes').innerText = 'Осталось жизней: ' + team2.currentLives || 0;
    }
};
/* BLOCK 5 END */
