...
var btnStart = document.getElementById("B1");
var btnStop = document.getElementById("B2");
var btnCancel = document.getElementById("B7");
   function visi (){
       btnStart.classList.add("VisibleOff");
       btnStop.classList.add("VisibleOff");
       btnCancel.classList.add("VisibleOff");
   }
...
setInterval(function() {
    var ftName = gameController.game.team1Stats.Name;
    var ftScore = gameController.team1Stats.Score;
    var stLifes = gameController.game.team2Stats.Lifes;
    var stName = team2Stats.Name;
    var stScore = team2Stats.Score;
    var stLifes = team2Stats.Lifes;
},1000);
/* BLOCK 5 END */
