...
// ERROR: gameController.exit is not a function
function exit() {
...
document.addEventListener("keydown", function(event) {
    ...
    if (event.keyCode) {
        let direction = jsHelper.getDirection(event.keyCode);
...
var showScore = setInterval(function() {
    if (gameController.game != null) {
        let team1 = gameController.game.team1Stats;
        let team2 = gameController.game.team2Stats;
